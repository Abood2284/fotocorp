...
export function HomeHero({ events }: HomeHeroProps) {
  return (
    <section
      className="relative flex min-h-72 w-full items-center justify-center overflow-hidden bg-surface-warm md:min-h-84"
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-4xl flex-col items-center px-4 py-6 text-center">
        <h1 className="mb-2 w-full max-w-[100vw] whitespace-nowrap text-center font-medium leading-none tracking-[-0.015em] text-foreground [font-size:clamp(0.9375rem,5.25vw,2.25rem)]">
          India&apos;s licensed news photography
        </h1>
        <p className="mb-4 max-w-md text-sm leading-snug text-muted-foreground">
