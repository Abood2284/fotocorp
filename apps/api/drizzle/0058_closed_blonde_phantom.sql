...
CREATE UNIQUE INDEX "help_contextual_links_context_article_uidx" ON "help_contextual_links" USING btree ("context_key","article_id");--> statement-breakpoint
CREATE INDEX "help_contextual_links_context_key_idx" ON "help_contextual_links" USING btree ("context_key");--> statement-breakpoint
CREATE INDEX "help_contextual_links_article_id_idx" ON "help_contextual_links" USING btree ("article_id");--> statement-breakpoint
